...
その中で中古ヨーヨーに注目し、使わなくなった・使えなくなったヨーヨーの価値をもう一度見直し、本当に必要とする人のもとへヨーヨーが行き届いて欲しいという思いでアプリを開発しました。<br>このアプリは、ヨーヨーを売りたい人とヨーヨーを探している人同士のスムーズな取引を可能にし、双方が満足できる場を提供することを目的としています。それによって、眠っていたヨーヨーの価値を循環させ、結果的に廃棄問題にも貢献することを目指しています。<br>アプリのロゴには、ヨーヨーが回転するように、ヨーヨーの価値も循環させたいという思いが込められています。
